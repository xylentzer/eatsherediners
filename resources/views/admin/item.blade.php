...
<body class="bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center min-h-screen">
  ...
  <div
    class="relative bg-white/10 backdrop-blur-md border border-gray-700 rounded-2xl shadow-2xl w-full max-w-md text-white p-8">
    ...
    <div class="flex justify-around mb-6 border-b border-gray-700">
      ...
      <button id="registerTab" class="py-2 font-semibold text-gray-400 hover:text-[#E63946] transition">Register</button>
    </div>
